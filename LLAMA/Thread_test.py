...
MODEL_BEING_TESTED = "meta-llama/Llama-3.1-70B-Instruct"
...
COOLING_PERIOD_S = 30
OUTPUT_CSV_FILE = "/app/results/results_vllm_llama_4096.csv"  # Save to mounted volume
            ...
            for pos_name, pos_ratio in needle_positions:
                ...
                completion = client.chat.completions.create(
                    ...
                    messages=[
                        {
                            "role": "system",
                            "content": "You are a helpful assistant. Carefully read the document and answer the question based only on the document."
                        },
                        {
                            "role": "user",
                            "content": prompt
